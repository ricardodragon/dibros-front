        ...
        values.anuncios.map((anuncio, indexAnuncio) =>            
            <section className="card-anuncio">                  
                ...
                <div style={{borderTop:"1px solid rgba(0, 0 , 0, 0.1)", textAlign:"center", fontSize:"11pt", padding:"1%", width:"100%"}}>
                    ...
                    <div style={{display:"inline-block", width: "33%", textOverflow: "ellipsis", maxWidth: "16ch", overflow: "hidden", whiteSpace: "nowrap", cursor: "pointer"}}><Link style={{textDecoration:'none'}} to={"/anuncio-compra/"+anuncio.id}>🛒</Link></div>
                </div>
